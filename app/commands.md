...
#### Params:
```bash
{ GOOGLE_CRED_FILE_PATH: '/Users/li/_CODE_/wings-SCGPM/app/credentials/850af0f0-ca97-11e9-a74d-7f966956fa0b.json',
  region: 'us-central1',
...
```bash
{
  GOOGLE_CRED_FILE_PATH: '/Users/li/_CODE_/wings-SCGPM/app/credentials/54ae42d0-caa2-11e9-b639-9138d7fe090c.json',
  region: 'us-central1',
...
#### Commands:
```bash
gsutil cp -r /Users/li/_CODE_/wings-SCGPM/app/setting-files/gatk-mvp/gatk-mvp-pipeline/ gs://gbsc-gcp-project-annohive-dev-user-lektin &&     gsutil cp /Users/li/_CODE_/wings-SCGPM/app/temp/1567113425265/ERR250256.hg38.inputs.json gs://gbsc-gcp-project-annohive-dev-user-lektin/ERR250256/ &&     export GOOGLE_APPLICATION_CREDENTIALS=/Users/li/_CODE_/wings-SCGPM/app/credentials/54ae42d0-caa2-11e9-b639-9138d7fe090c.json &&     dsub       --provider google-v2       --project gbsc-gcp-project-annohive-dev       --regions us-central1       --min-cores 1       --min-ram 6.5       --image 'jinasong/wdl_runner:latest'       --logging gs://gbsc-gcp-project-annohive-dev-user-lektin/ERR250256/logging       --input CFG=gs://gbsc-gcp-project-annohive-dev-user-lektin/gatk-mvp-pipeline/google-adc.conf       --input OPTION=gs://gbsc-gcp-project-annohive-dev-user-lektin/gatk-mvp-pipeline/generic.google-papi.options.json       --input WDL=gs://gbsc-gcp-project-annohive-dev-user-lektin/gatk-mvp-pipeline/fc_germline_single_sample_workflow.wdl       --input SUBWDL="gs://gbsc-gcp-project-annohive-dev-user-lektin/gatk-mvp-pipeline/tasks_pipelines/*.wdl"       --input INPUT=gs://gbsc-gcp-project-annohive-dev-user-lektin/ERR250256/ERR250256.hg38.inputs.json       --env MYproject=gbsc-gcp-project-annohive-dev       --env ROOT=gs://gbsc-gcp-project-annohive-dev-user-lektin/ERR250256/output       --command 'java -Dconfig.file=${CFG} -Dbackend.providers.JES.config.project=${MYproject} -Dbackend.providers.JES.config.root=${ROOT} -jar /cromwell/cromwell.jar run ${WDL} --inputs ${INPUT} --options ${OPTION}' &&    rm -rf /Users/li/_CODE_/wings-SCGPM/app/temp/1567113425265
```
#### Job id:
